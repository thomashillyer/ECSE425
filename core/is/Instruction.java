...
/**
 * Abstract class: it provides all methods and attributes for each instruction
 * type
 * 
...
public abstract class Instruction {
	 ...
	 * 
	 * @param name
	 *            string value to pass in order to instanciate an instruction object
	...
	public void IF() throws RAWException, IrregularWriteOperationException, IrregularStringOfBitsException,
			JumpException, TwosComplementSumException, BreakException {
	}
	...
	public abstract void EX()
			throws HaltException, IrregularStringOfBitsException, IntegerOverflowException, TwosComplementSumException,
			IrregularWriteOperationException, IrregularWriteOperationException, DivisionByZeroException;
	 ...
	 * </pre>
	 **/
	public abstract void MEM() throws HaltException, IrregularStringOfBitsException, MemoryElementNotFoundException,
	...
	/**
	 * <pre>
	 * Sets the instruction with a list of parameters Passed list | Instruction to
	 * set e.g. list= { 1, 2, 3} | DADD R1,R2,R3 list= { 1, address memory
	 * corresponding with var, 0} | LD R1, var(R0)
	 * 
	 * @param params
	 ...
	 * 
	 * @param value
	 *            full name of the instruction (e.g. "DADD R1,R2,R3")
	 */
	...
	/**
	 * Sets the comment of the instruction as string. The comment is the text after
	 * every semicolon in the file .s
	 * 
	...
	/**
	 * Gets the comment of the instruction as string.The comment is the text after
	 * every semicolon in the file .s
	 * 
	 * @return the comment
	 */
	 ...
	 * 
	 * @param value
	 *            This variable enable the forwarding modality if it is true
	 */
	...
	/**
	 * Gets the state of EnableForwarding. This modality anticipates writing on
	 * registers at EX stage for Alu instructions or at MEM stage for Load-Store
	 * instructions
	 * 
